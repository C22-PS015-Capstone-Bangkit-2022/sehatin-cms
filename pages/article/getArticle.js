...
const listArticle = () => {
  ...
  useEffect(() => {
    axios
      .get("http://sehatin-api.herokuapp.com/v1/articles")
      .then((res) => {
            ...
            >
              ...
              <Box p="6">
                ...
                <Box display="flex" mt="2" alignItems="center">
                  {/* <Text>Source : </Text> */}
                  <Box as="span" ml="2" color="gray.600" fontSize="sm" noOfLines={2}>
                    {v.source}
                  </Box>
                </Box>
              </Box>
              <Stack direction="row" float="right" marginRight="8px" position="relative">
                <Button>
